namespace ExtremeIS.Model.Entities
{
    ...
    public partial class ExtremeAppDb : DbContext
    {
        ...
        public virtual DbSet<gear_rental> gear_rental { get; set; }
        public virtual DbSet<gear_rental_items> gear_rental_items { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<gear_rental>()
                .Property(e => e.renter_first_name)
                .IsUnicode(false);

            modelBuilder.Entity<gear_rental>()
                .Property(e => e.renter_last_name)
                .IsUnicode(false);

            modelBuilder.Entity<gear_rental>()
                .Property(e => e.renter_id_number)
                .IsUnicode(false);

            modelBuilder.Entity<gear_rental>()
                .Property(e => e.renter_phone_number)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<gear_rental_items>()
                .Property(e => e.quantity)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<user_account>()
                .HasMany(e => e.gear_rental)
                .WithRequired(e => e.user_account)
                .HasForeignKey(e => e.issuer_user_account_id);

            modelBuilder.Entity<user_account>()
                .HasMany(e => e.gear_rental1)
                .WithOptional(e => e.user_account1)
                .HasForeignKey(e => e.receiver_user_account_id)
                .WillCascadeOnDelete();
